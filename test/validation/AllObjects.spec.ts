...
import {ArbitraryEmpty} from "../arbitrary/ArbitraryEmpty";
...
import {ArbitraryOptional} from "../arbitrary/ArbitraryOptional";
...
import {OptionalValidation} from "../../src/validation/OptionalValidation";
...
import {EmptyValidation} from "../../src/validation/EmptyValidation";
...
test(EmptyValidation, ArbitraryEmpty);
...
test(OptionalValidation, ArbitraryOptional);
